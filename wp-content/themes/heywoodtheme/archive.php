...
<?php get_header(); ?>
  ...
  <div class="hero grad-bg">
    <div class="container">
      <h1><?php 
              if ( is_day() ) {
                printf( __( 'Daily Archives for %s', 'stc' ), get_the_date() );
              } elseif ( is_month() ) {
                printf( __( 'Monthly Archives for %s', 'stc' ), get_the_date( _x( 'F Y', 'Monthly archives date format', 'stc' ) ) );
              } elseif ( is_year() ) {
                printf( __( 'Yearly Archives for %s', 'stc' ), get_the_date( _x( 'Y', 'Yearly archives date format', 'stc' ) ) );
              } else {
                _e( 'Archives', 'stc' );
              }
            ?>
